...
export default class GoodsDetails extends React.Component {
    ...
    specsRender = () => {
        return <div className="detail-specs">
			<div className="detail-specs-item big">
				<span>优惠</span>
    ...
    footerRender = () => {
        return <div className="detail-control">
            ...
            <div className="detail-control-right">
                <button class="detail-control-right-button default">加入购物车</button>
                <button class="detail-control-right-button success">立即购买</button>
            </div>
        </div>
    }
    render() {
